...
export function ScholarIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 24a7 7 0 0 1-3.5-.94L0 18.5l3.5-2.13v-3.55C3.5 9.44 7.08 6.5 12 6.5s8.5 2.94 8.5 6.32v3.55L24 18.5l-8.5 4.56A7 7 0 0 1 12 24zM5.5 16.37v1.45l6.5 3.49 6.5-3.49v-1.45C17.16 17.94 14.72 19 12 19s-5.16-1.06-6.5-2.63zM12 8.5c-3.81 0-6.5 2.08-6.5 4.32S8.19 17 12 17s6.5-2.14 6.5-4.18S15.81 8.5 12 8.5z"/>
